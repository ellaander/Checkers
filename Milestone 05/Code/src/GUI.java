...
// Inside your constructor or initialization method
    ...
    File howtoplay = new File("FERRET1.jpeg");
    File settings = new File ("FERRET1.png");
      
    ImageIcon howToPlayImage = new ImageIcon(howtoplay.getPath());
    ImageIcon settingsImage = new ImageIcon(settings.getPath());
    ...
    //SOUNDS METHOD
    private void playLoopSound(String soundFilePath, int loopCount) {
            String soundFile = new File(soundFilePath).toURI().toString();
            Media hit = new Media(soundFile);
            mediaPlayer = new MediaPlayer(hit);

            // Media player plays sounds indefinitely 
    ...
    public GUI() 
    {
        ...
        settingsComponent4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                playLoopSound("Sound/CoolRevenge.mp3", MediaPlayer.INDEFINITE);
            }
        });
        ...
        settingsComponent5.addActionListener(new ActionListener() 
        {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Play sound in a loop (indefinitely)
                playLoopSound("Sound/July.mp3", MediaPlayer.INDEFINITE);
            }
        });
        ...
        settingsComponent6.addActionListener(new ActionListener() 
        {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Play sound in a loop (indefinitely)
                playLoopSound("Sound/Summer.mp3", MediaPlayer.INDEFINITE);
            }
        });
        ...
        //imageCheckersMoveExample.setBounds();
        settingsPanel.add(imageCheckersMoveExample);

        JLabel imageCheckersJumpExample = new JLabel(checkersJumpExample);
        //imageCheckersJumpExample.setBounds();
        settingsPanel.add(imageCheckersJumpExample);
